...
class paymentPartner2 extends StatefulWidget {
  const paymentPartner2({Key key}) : super(key: key);
  static const routeName = '/adminprofilepage';
  @override
  State<paymentPartner2> createState() => _paymentPartnerState();
}

class _paymentPartnerState extends State<paymentPartner2> {
  @override

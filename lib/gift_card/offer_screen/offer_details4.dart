...
class offer4 extends StatefulWidget {
  static const routeName = '/offer4';
  const offer4({Key key}) : super(key: key);

  @override
  _offer4State createState() => _offer4State();
}

class _offer4State extends State<offer4> {
  @override
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Use Coupon BUS1000: Get Upto RS.1000 Cashback',
                  style: TextStyle(
                ...
                Text(
                  'Apply coupon code BUS100 at bus checkout and get 100% upto Rs.1000 Promo Cashback.',
                ...
                Text(
                  'This offer is valid on a minimum transaction value of Rs.5000.',
                  style: TextStyle(letterSpacing: 0.5),
                ),
                SizedBox(
                  height: 10.0,
                ...
                Text(
                  'All customers who have applied BUS1000 and successfully completed the transaction will receive the cashback post journey completion.',
                  style: TextStyle(letterSpacing: 0.5),
                ),
                SizedBox(
                  height: 10.0,

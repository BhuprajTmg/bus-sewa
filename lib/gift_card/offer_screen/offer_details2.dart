          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Use Coupon 225 CASHBACK: Get Upto RS.225 Cashback',
                  style: TextStyle(
                ...
                Text(
                  'Apply coupon code 225 CASHBACK to get 10% upto Rs.225 Instant Discount +Rs.100 TracknGo Cashback.',
                ...
                Text(
                  'This offer is valid on a minimum transaction value of Rs.500.',
                  style: TextStyle(letterSpacing: 0.5),
                ),
                SizedBox(
                  height: 10.0,
                ...
                Text(
                  'All customers who have applied 225 CASHBACK and successfully completed the transaction will receive the cashback post journey completion.',
                  style: TextStyle(letterSpacing: 0.5),
                ),
                SizedBox(
                  height: 10.0,
                ...
                Text(
                  'Offer is valid between MAy1-July 31, 2021.',
                  style: TextStyle(letterSpacing: 0.5),
                ),
                SizedBox(
                  height: 10.0,

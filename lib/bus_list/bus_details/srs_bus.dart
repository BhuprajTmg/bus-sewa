...
class srs extends StatefulWidget {
  static const routeName = '/srs';
  const srs({Key key}) : super(key: key);
...
class _srsState extends State<srs> {
  final String image = 'assets/images/srs.jpg';
